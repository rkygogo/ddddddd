...
RUN wget -c -P /usr/share/nginx https://github.com/AYJCSGM/mikutap/archive/master.zip >/dev/null \
&& unzip -o "/usr/share/nginx/mikutap-master.zip" -d /usr/share/nginx/html >/dev/null
